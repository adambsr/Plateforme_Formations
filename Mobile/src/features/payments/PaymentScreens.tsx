...
const styles = StyleSheet.create({
  ...
  statusPending: { color: colors.warning, backgroundColor: colors.warningSoft },
  statusPaid: { color: colors.success, backgroundColor: colors.successSoft },
  statusFailed: { color: colors.danger, backgroundColor: colors.dangerSoft },
